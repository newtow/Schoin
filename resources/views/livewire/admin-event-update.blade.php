<div class="w-2/4 ml-5">
    ...
    <div class="p-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700">
        <form class="space-y-6" wire:submit.prevent="updateevent">
           <input type="hidden" wire:model="eventid" name="">
            <h5 class="text-xl font-medium text-gray-900 dark:text-white">Form Update Event</h5>
            <div>
